...
# ============================================================
# Estilos customizados (CSS) para deixar o layout mais moderno
# ============================================================

custom_css = """
<style>
/* Fundo em degradê sutil */
.main {
...
/* Inputs da sidebar com fundo mais escuro */
...
def hero_section():
    st.markdown(
        ...
        <div class="hero-box">
            ...
            <p style="font-size:1.0rem; color:#cbd5f5; max-width: 820px; line-height: 1.6;">
...
def page_contact():
    ...
    with col1:
        with st.form("contact_form"):
            ...
            if submitted:
                # Aqui você pode salvar no MongoDB em uma collection "leads" ou "contatos"
                leads_col = db["leads"]
